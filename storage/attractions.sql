...
(100) DEFAULT '',
    storymap_slides_road_description VARCHAR
(100) DEFAULT '',
    storymap_slides_entrance_fee VARCHAR
(100) DEFAULT '',
    storymap_slides_visitors VARCHAR
(100) DEFAULT '',
    storymap_slides_notices VARCHAR
(100) DEFAULT ''
);

INSERT INTO attractions
    (storymap_slides_location_lat, storymap_slides_location_lon, storymap_slides_text_headline, storymap_slides_text_text, storymap_slides_media_url, storymap_slides_media_caption, storymap_slides_media_credit, storymap_slides_road_description, storymap_slides_entrance_fee, storymap_slides_visitors, storymap_slides_notices)
